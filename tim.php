      ...
      <div class="container">
        <nav class="site-navbar">
          ...
          <ul class="menu" id="menu">
            ...
            <li><a href="#healthify">Tanya Dokter</a></li>
            <li><a href="artikel.php">Artikel</a></li>
            <!-- <li><a href="healthify.php">Chat Dokter</a></li> -->
            <li class="active"><a href="cobatim.php">Tim</a></li>
  ...
  <div class="tentang-2">
    <div class="tentang-2-konten">
      <div class="t2-konten-kiri">
        ...
        <p class="t2-subjudul">
          Karedok Team merupakan kelompok 1 pada mata kuliah Pemrograman Web
...
<!-- fade animation -->
<script src="after_login/script.js"></script>
